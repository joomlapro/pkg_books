...
class BooksViewBook extends JView
{
	...
	public function display($tpl = null)
	{
		...
		$doc->setTitle(JText::_('COM_BOOKS_BOOK_TITLE'));
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_BOOKS_BOOK_ADD') : JText::_('COM_BOOKS_BOOK_EDIT'), 'books.png');
